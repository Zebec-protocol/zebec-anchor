...
describe("zebec native startPauseWithdrawAfterEnd", () => {
  ...
  it("Withdraw Sol", async () => {
    ...
    if (paused == "1") {
      ...
      console.log(
        "case 1==> its paused and withdraw time is greater than end time",
      ...
      let expectedZebecVaultBalance = Number(
        (zebecVaultBalanceBeforeWithdraw - expectedWithdrawAmount).toFixed()
      );
      let expectedReceiverBalance = Number(
        (
