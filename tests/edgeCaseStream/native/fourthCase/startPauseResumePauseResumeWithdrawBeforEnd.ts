...
describe("zebec native startPauseResumePauseResumeWithdrawBeforEnd", () => {
  ...
  it("Withdraw Sol", async () => {
    ...
    if (firstPaused == "1" && secondPaused == "1") {
      ...
      console.log(
        "case 1==> its paused and resume and again pause and resume and then withdraw time is less than end time",
      ...
      assert.equal(withdrawAmount, expectedWithdrawAmount.toFixed(0));
