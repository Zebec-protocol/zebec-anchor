...
describe("zebec token startWithDrawPauseResumeWithDrawAfterEnd", () => {
  ...
  it("Withdraw Token Stream", async () => {
    ...
    if (paused == "1") {
      ...
      console.log(
        "case 2==> its withdraw paused and resume and then again withdraw time is greater than end time",
      ...
      let expectedZebecVaultBalance =
        zebecVaultBalanceBeforeWithdraw -
        parseInt(secondWithdrawAmount.toString());
