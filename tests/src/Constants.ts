...
export const batchTransferProgramId = new anchor.web3.PublicKey(
  "66M9Ce7UvRUZASC5n1BU41QHHJ7RhAMPB6EcZDGedhxz"
);
...
const batchTransferIdl = JSON.parse(
  require("fs").readFileSync("./target/idl/batch_transfer.json", "utf8")
);

export const batchTransferProgram = new anchor.Program<BatchTransfer>(
  batchTransferIdl,
  batchTransferProgramId
);
